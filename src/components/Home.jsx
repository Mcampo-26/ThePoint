        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center z-50">
          <div className="relative bg-white p-8 rounded-lg shadow-lg w-11/12 sm:w-4/5 max-w-lg h-auto">
            ...
            <div className="flex justify-center space-x-8 mb-6">
              <button
                className={`flex justify-center items-center w-40  h-13 rounded-md shadow-md border border-gray-300 transition-shadow duration-200 ${
              ...
              <button
                className={`flex justify-center items-center w-32 h-13 rounded-md shadow-md border border-gray-300 transition-shadow duration-200 ${
